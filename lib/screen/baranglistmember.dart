...
class BarangListMember extends StatefulWidget {
  @override
  State<BarangListMember> createState() => _BarangListMemberState();
}

class _BarangListMemberState extends State<BarangListMember> {
